...
//     head2.appendChild(pokimonName);
//     head2.appendChild(pokimonIdNum);
// };
// charmHeader(charmObj);

// function charmandersTypes() {
//     let pokeType = charmObj["types"];
//     let statistical = document.getElementById("stats2");
...
function start() {
    let filename = window.location.href.substr(window.location.href.lastIndexOf("/") + 1);
    ...
    if (filename == "index.html") {
        currentPage = "";
    } else if (filename == "charmander.html") {

        currentPage = charmander;
        let chariObj = JSON.parse(currentPage);
        setTimeout(function () {
            chariHeader(chariObj);
            createPowers(chariObj);
            createTypes(chariObj);
        }, 100);
    } else if (filename == "charmeleon.html") {

        currentPage = charmeleon;
        let chariObj = JSON.parse(currentPage);
        ...
        $("#charmBody").on("click", function () {
            ...
            createSection(currentPage);
            createPicture(currentPage);
        })

        function createPicture(chariObj) {

            const H1 = document.createElement("h1");
            H1.textContent = `${chariObj["name"]}`
            picture2.appendChild(H1)
        ...
        function createHeader(chariObj) {
            //base 
            const h2 = document.createElement("h2");
            h2.textContent = `Base Experience:`;
            header2.appendChild(h2)
            const p1 = document.createElement("p1");
            p1.textContent = ` ${chariObj["base_experience"]}`
            header2.appendChild(p1)
            ...
            const p2 = document.createElement("p2");
            p2.textContent = `${chariObj["height"]}`
            header2.appendChild(p2)
            ...
            const p6 = document.createElement("p6");
            p6.textContent = `${chariObj["weight"]}`
            header2.appendChild(p6)
            ...
            const p4 = document.createElement("p4");
            p4.textContent = `${chariObj["id"]}`
            header2.appendChild(p4)
        }
        function createSection(chariObj) {
            const abilitie = chariObj["abilities"];
            const types = chariObj["types"];
            const status = chariObj["stats"]
            for (tys in types) {
                //slot
                const h7 = document.createElement("h11");
                h7.textContent = `Slot:`;
        ...
        createSection(chariObj)
        createHeader(chariObj)
        createPicture(chariObj)


    } else if (filename == "charizard.html") {
        currentPage = charizard;
        let chariObj = JSON.parse(currentPage);
        setTimeout(function () {
            chariHeader(chariObj);
            createPowers(chariObj);
